  ...
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="操作">
        <template scope="scope">
          <el-button size="small" type="success" icon="eidt" @click="handleEdit(scope.row)">审批</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 弹出窗口 -->
    <el-dialog title="审批" :visible.sync="dialogFormVisible" v-if="dialogFormVisible"  size="full">
...
<script>
  import { getApprovalList } from '@/api/extension';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getApprovalList(this.listQuery).then(response => {
