  ...
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="操作">
        <template scope="scope">
          <el-button size="small" type="success" icon="eidt" @click="handleEdit(scope.row)">处理</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 弹出窗口 -->
    <el-dialog title="处理" :visible.sync="dialogFormVisible" v-if="dialogFormVisible"  size="full">
...
<script>
  import { getDealList } from '@/api/extension';
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        getDealList(this.listQuery).then(response => {
